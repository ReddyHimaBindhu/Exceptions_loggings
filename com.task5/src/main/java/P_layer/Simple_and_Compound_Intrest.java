...
public class Simple_and_Compound_Intrest implements Presented{
	private static final Logger LOGGER=LogManager.getLogger(Simple_and_Compound_Intrest.class);
	public static void main(String[] args) {
		Simple_and_Compound_Intrest object=new Simple_and_Compound_Intrest();
